...
- 角色管理：依停手、待投資、待測及封存篩選，支援搜尋；單一角色分為總覽、能力面板、API 裝備資訊、戰力紀錄。
...
- nexon 保存最近同步時間、角色圖、伺服器、公會、性別、創角日期、經驗值、API 能力值及目前裝備。角色查看頁以角色資料主卡呈現這些資料。手動 stats、equipment、Boss、備註、結晶與舊戰力紀錄不會被覆蓋。
